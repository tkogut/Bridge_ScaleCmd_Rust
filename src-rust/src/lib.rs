...
mod tests {
    ...
    fn test_device_config_creation() {
        // DeviceConfig now uses host_id and miernik_id references
        let config = DeviceConfig {
            name: "Test Scale".to_string(),
            manufacturer: "Test Manufacturer".to_string(),
            model: "Test Model".to_string(),
            host_id: "host-1".to_string(),
            miernik_id: "miernik-1".to_string(),
            enabled: true,
        };
        ...
        assert_eq!(config.miernik_id, "miernik-1");
    ...
    fn test_app_config_serialization() {
        ...
        assert_eq!(device.host_id, "host-1");
        assert_eq!(device.miernik_id, "miernik-1");
